...
describe("CardDetailContent", () => {
    describe("rendering", () => {
        ...
        it("shows 'Free' when price is '0.00'", () => {
            render(<CardDetailContent {...defaultProps} data={{ ...mockGame, price: "0.00" }} />);
            expect(screen.getByText("Free")).toBeInTheDocument();
        });

        it("shows '-' when price is null", () => {
            render(<CardDetailContent {...defaultProps} data={{ ...mockGame, price: null }} />);
        ...
        it("shows 'No comments added yet.' when comment is null", () => {
            render(<CardDetailContent {...defaultProps} data={{ ...mockGame, comment: null }} />);
    ...
    describe("interaction", () => {
        it("calls setEditMode(true) when Edit button is clicked", async () => {
            ...
            render(<CardDetailContent {...defaultProps} setEditMode={setEditMode} />);
        ...
        it("calls handleOnDeleteById with data._id when Remove button is clicked", async () => {
            ...
            render(<CardDetailContent {...defaultProps} handleOnDeleteById={handleOnDeleteById} />);
