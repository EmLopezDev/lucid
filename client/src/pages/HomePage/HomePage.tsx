            ...
            <section className="home-page__features">
                <div className="home-page__feature">
                    ...
                    <p className="home-page__feature-text">
                        Sort games by status — Playing, Completed, Paused, Dropped, or Wishlist.
                ...
                <div className="home-page__feature">
                    ...
                    <p className="home-page__feature-text">
                        Log hours played, leave a rating, and capture your thoughts while they're
                        fresh.
                    </p>
                </div>
                <div className="home-page__feature">
                    ...
                    <p className="home-page__feature-text">
                        PlayStation, Xbox, Nintendo, PC — every platform you own, tracked in one
                        place.
                    </p>
                </div>
            </section>
